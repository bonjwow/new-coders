...
\begin{equation}
(\#eq:linRegModel2)
Y \sim \beta_0 + \beta_1X_1 + \beta_2X_2 + \beta_3X_3 + \beta_4X_4 + \beta_5X_5 + \epsilon
\end{equation}
...
stargazer::stargazer(multiReg1, multiReg2, multiReg3, 
          title = "Predictions of money for learning across experimental conditions", 
          header = FALSE,
          type = "latex")
```
...
stargazer::stargazer(linReg1, linReg2, linReg3, linReg4,
          ...
          header = FALSE,
          type = "latex",
          column.labels = c("Any", "Small", "Medium", "Large"),
          font.size = "tiny")
...
dfModelValid <-
  ...
  kable(caption = "Model validation",
        booktabs = TRUE,
