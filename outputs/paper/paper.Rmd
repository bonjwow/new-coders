...
This equation \@ref(eq:linRegModel1) is a model formula for Model (1).
...
This equation \@ref(eq:linRegModel2) is a model formula for Model (2).
...
This equation \@ref(eq:linRegModel3) is a model formula for Model (3).
...
This equation \@ref(eq:linRegModel4567) is a model formula for Model (4), (5), (6) and (7).
...
dfModelValid <-
  ...
  kable(caption = "Results of model validation metrics",
        booktabs = TRUE,
...
```{r}
#### Beta ####
# TODO: create a bar plot to show which variable affects the most 
QuantPsyc::lm.beta(multiReg2)
