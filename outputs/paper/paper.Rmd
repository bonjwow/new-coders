...
tabCleanedData <-
  ...
  kable(caption = "A partial view of \\\\the cleaned dataset",
      booktabs = T,
      escape = F,
      "latex",
...
plot(dfNewCoders$MoneyForLearning)
lines(multiReg1$fitted.values, col = "red")
lines(multiReg2$fitted.values, col = "blue")
lines(multiReg3$fitted.values, col = "green")

```

```{r}
#### RMSE ####
forecast::accuracy(multiReg1)
```
